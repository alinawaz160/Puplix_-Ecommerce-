...
if (isset($_GET['type']) && $_GET['type'] != '') {
    ...
    if ($type == "status") {
        ...
        $update_query = "UPDATE categories set status='$status' WHERE id='$id'";
...
<body>
    ...
    <section id="content">
        ...
        <nav>
            ...
            <a href="manage_categories.php" class="btn-add-categories">+ Add</a>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($res)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo "<a class='btn btn-info btn-sm' href='manage_categories.php?id=" . $row['id'] . "'><i class='bx bx-edit'></i></a>"; ?>
