...
if (isset($_GET['type']) && $_GET['type'] != '') {
    ...
    if ($type == "status") {
        ...
        $update_query = "UPDATE product set status='$status' WHERE id='$id'";
...
<body>
    ...
    <section id="content">
        ...
        <nav>
            ...
            <a href="manage_product.php" class="btn-add-categories">+ Add</a>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th> Categories <span class="icon-arrow">&UpArrow;</span></th>
                        <th> Name <span class="icon-arrow">&UpArrow;</span></th>
                        <th> Price <span class="icon-arrow">&UpArrow;</span></th>
                        <th> MRP <span class="icon-arrow">&UpArrow;</span></th>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($res)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo "<a class='btn btn-info btn-sm' href='manage_product.php?id=" . $row['id'] . "'><i class='bx bx-edit'></i></a>"; ?>
